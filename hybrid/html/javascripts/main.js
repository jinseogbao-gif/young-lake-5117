...
//_HOST = "centurygoldmt6";				//本地測試用		打包部署请注释 使用上面动态获取域名
...
var _DOMAIN = 'http://lingye-api.stock.test/crypto/v1'
...
function layer_confirm2(con, data, callback) {
  ...
  layer.open({
    type: 1,
    title: '<img class="modal-logo" src="images/modal-logo-z.jpg" alt="">',
...
function get_all_params() {
  ...
  // console.log(paraObj, 'paraObjparaObjparaObjparaObj')

  return paraObj
  let localObj = localStorage.getItem('leverOrder')
  // return {
  //   legal_id: '',
  //   currency_id: '',
  //   symbol: 'ETHUSD',
...
function initDataToken(params, callback) {
  ...
  var lang = getlocal_storage('lang') || 'en'
